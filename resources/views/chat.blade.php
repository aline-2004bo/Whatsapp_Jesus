<x-app-layout>
    ...
    <script>
        ...
        // 2. Funciones del visor de imágenes
        ...
        // 3. Cargar mensajes del servidor
            ...
            fetch('/messages/' + receiver)
                ...
                .then(data => {
                    ...
                    data.forEach(msg => {
                        ...
                        // Manejo de archivos adjuntos (imágenes, PDF u otros)
                        if (msg.file) {
        ...
        // 5. Mostrar vista previa al seleccionar un archivo
